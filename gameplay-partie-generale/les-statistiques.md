...
{% hint style="success" %}
Vous pouvez également obtenir un important bonus de statistiques grâce aux <mark style="color:yellow;">**Âmes**</mark> récupérées sur [_**Thriller Bark**_](../gameplay-partie-aventure/les-iles-aventure/thriller-bark.md) et grâce aux <mark style="color:pink;">**Valerianes**</mark> récupérées sur [_**Drum**_](../gameplay-partie-aventure/les-iles-aventure/royaume-de-drum.md), offrant des statistiqurs supplémentaires une fois un palier débloqué. Regardez ou vous en êtes dans les paliers en cliquant sur les blocs "?" à coté des coffres sur les deux îles puis dans "Activités".
{% endhint %}
